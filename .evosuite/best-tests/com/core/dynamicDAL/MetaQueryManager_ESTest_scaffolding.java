...
public class MetaQueryManager_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.core.dynamicDAL.MetaQueryManager"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MetaQueryManager_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.core.util.PropertiesWrapper",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MetaQueryManager_ESTest_scaffolding.class.getClassLoader()); 
